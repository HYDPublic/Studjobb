...
from src.company.logo    import LogoDownloader
...
class TestCompanyLogo(unittest.TestCase):
    ...
    @mock.patch('src.company.logo.LogoConfig.pathToStore')
    ...
    @mock.patch('src.company.logodownloader.requests')
    ...
    @mock.patch('src.company.logoconfig.SafeConfigParser')
    ...
    @mock.patch('src.company.logo.LogoConfig.pathToStore')
    @mock.patch('src.company.logo.LogoConfig.urlToLogosFromConfig')
